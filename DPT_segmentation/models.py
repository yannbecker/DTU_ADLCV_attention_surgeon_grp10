...
class DPT(BaseModel):
    def __init__(
        ...
        hooks = {
            "vitb14_224": [2, 5, 8, 11] # A MODIFIER : Pas besoin d'un dictionnaire
        }
...
class DPTSegmentationModel(DPT):
    def __init__(self, num_classes = 150, path=None, **kwargs): # A MODIFIER -> Nombre de classes dans ADE20K 150 MAIS attention à O = background
